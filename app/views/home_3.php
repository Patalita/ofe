...
<head>
<title>Home | On-line Faculty Evaluation</title>
...
<div id="container">
  <div id="header">
   ...
   <div id="navigation">
	<ul>
     <li class="selected"><a href="checks">Home</a></li>
      <li><a href="displaySubjects">List of Subjects</a></li>     
  ...
  <div id="content">
    ...
    <h2>Welcome <?php echo $data['first_name'];?>!</h2>
    ...
    <h3>Rationale for Online Faculty Evaluation System</h3>
    <p>
